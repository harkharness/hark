    ...
    fn spend_rows_export_returns_full_rows_since() {
        ...
        store
            .record_spend(&[
                ...
                row("2026-08-21T09:00:00Z", Some("hark-chat")),
            ])
            .unwrap();
        ...
        let r = &rows[0];
        assert_eq!(r.task_id.as_deref(), Some("hark-chat"));
